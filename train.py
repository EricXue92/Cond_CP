...
# train and return best_model_path, last_checkpoint_path
   ...
   # Load data
    ...
    if os.path.exists(best_model_path):
        if args.overwrite:
            ...
            best_model_path, last_checkpoint_path = train_model(model, train_loader, calib_loader,
                                                                optimizer, loss_fn, args)
        else:
