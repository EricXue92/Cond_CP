...
def save_results(coverages_split, coverages_cond, metadata, test_labels, dataset_name, analysis_type):
    ...
    for col in available_cols:
        ...
        group_values = metadata.loc[test_mask, col].to_numpy()  # ensure 1D array
